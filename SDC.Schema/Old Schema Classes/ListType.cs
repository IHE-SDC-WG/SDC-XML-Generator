...
public partial class ListType : ExtensionBaseType
{
    ...
    private List<DisplayedType> _displayedItem;
    ...
    [System.Xml.Serialization.XmlElementAttribute("DisplayedItem", Order=0)]
    public virtual List<DisplayedType> DisplayedItem
    {
        get
        {
    ...
    [System.Xml.Serialization.XmlElementAttribute("DisplayedItem", typeof(DisplayedType), Order=1)]
    [System.Xml.Serialization.XmlElementAttribute("ListItem", typeof(ListItemType), Order=1)]
    ...
    /// <summary>
    /// Test whether DisplayedItem should be serialized
    /// </summary>
    public virtual bool ShouldSerializeDisplayedItem()
    {
        return DisplayedItem != null && DisplayedItem.Count > 0;
    }
