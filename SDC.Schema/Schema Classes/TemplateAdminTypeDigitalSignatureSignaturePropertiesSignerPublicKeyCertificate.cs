...
public partial class TemplateAdminTypeDigitalSignatureSignaturePropertiesSignerPublicKeyCertificate
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out TemplateAdminTypeDigitalSignatureSignaturePropertiesSignerPublicKeyCertificate obj, out System.Exception exception)
    {
        exception = null;
        obj = default(TemplateAdminTypeDigitalSignatureSignaturePropertiesSignerPublicKeyCertificate);
        try
    ...
    public static TemplateAdminTypeDigitalSignatureSignaturePropertiesSignerPublicKeyCertificate LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
