...
public partial class DataSourceTypeXML : DataStoreType
{
    ...
    private static XmlSerializer serializer;
        ...
        public virtual string_Stype Item { get; set; }
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out DataSourceTypeXML obj, out System.Exception exception)
    {
        exception = null;
        obj = default(DataSourceTypeXML);
        try
    ...
    public static DataSourceTypeXML LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static DataSourceTypeXML LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
