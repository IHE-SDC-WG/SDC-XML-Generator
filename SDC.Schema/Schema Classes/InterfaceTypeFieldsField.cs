...
public partial class InterfaceTypeFieldsField : ExtensionBaseType
{
    ...
    private static XmlSerializer serializer;
        ...
        public virtual string_Stype Getter { get; set; }
        [System.Xml.Serialization.XmlElementAttribute(Order=1)]
        public virtual string_Stype Setter { get; set; }
        [System.Xml.Serialization.XmlElementAttribute(Order=2)]
        public virtual string_Stype Action { get; set; }
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out InterfaceTypeFieldsField obj, out System.Exception exception)
    {
        exception = null;
        obj = default(InterfaceTypeFieldsField);
        try
    ...
    public static InterfaceTypeFieldsField LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static InterfaceTypeFieldsField LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
