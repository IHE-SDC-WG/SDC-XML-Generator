...
public partial class ItemMapType : ExtensionBaseType
{
    ...
    /// </summary>
        ...
        public virtual TemplateTargetType TemplateTarget { get; set; }
    /// <summary>
    ...
    /// </summary>
        ...
        public virtual List<RichTextType> MapComment { get; set; }
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ItemMapType obj, out System.Exception exception)
    {
        exception = null;
        obj = default(ItemMapType);
        try
    ...
    public static ItemMapType LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static ItemMapType LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
