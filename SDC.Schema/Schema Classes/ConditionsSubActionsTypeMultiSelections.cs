...
public partial class ConditionsSubActionsTypeMultiSelections : MultiSelectionSetBoolType
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ConditionsSubActionsTypeMultiSelections obj, out System.Exception exception)
    {
        exception = null;
        obj = default(ConditionsSubActionsTypeMultiSelections);
        try
    ...
    public static ConditionsSubActionsTypeMultiSelections LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static ConditionsSubActionsTypeMultiSelections LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
