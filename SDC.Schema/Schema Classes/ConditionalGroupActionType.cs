...
public partial class ConditionalGroupActionType : FuncBoolBaseType
{
    ...
    private static XmlSerializer serializer;
        ...
        [System.Xml.Serialization.XmlElementAttribute("Conditions", typeof(ConditionsSubActionsType), Order=0)]
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ConditionalGroupActionType obj, out System.Exception exception)
    {
        exception = null;
        obj = default(ConditionalGroupActionType);
        try
    ...
    public static ConditionalGroupActionType LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static ConditionalGroupActionType LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
