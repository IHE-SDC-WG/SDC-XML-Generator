...
public partial class SimpleSdcRetrieveFormPackageType : BasePackageType
{
    ...
    private static XmlSerializer serializer;
        ...
        public virtual List<SubmissionRuleType> SubmissionRule { get; set; }
        [System.Xml.Serialization.XmlElementAttribute("ComplianceRule", Order=1)]
        public virtual List<ComplianceRuleType> ComplianceRule { get; set; }
        [System.Xml.Serialization.XmlElementAttribute("HTMLPackage", typeof(byte[]), DataType="base64Binary", Order=2)]
        [System.Xml.Serialization.XmlElementAttribute("XMLPackage", typeof(SimpleSdcRetrieveFormPackageTypeXMLPackage), Order=2)]
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out SimpleSdcRetrieveFormPackageType obj, out System.Exception exception)
    {
        exception = null;
        obj = default(SimpleSdcRetrieveFormPackageType);
        try
    ...
    public static SimpleSdcRetrieveFormPackageType LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static SimpleSdcRetrieveFormPackageType LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
