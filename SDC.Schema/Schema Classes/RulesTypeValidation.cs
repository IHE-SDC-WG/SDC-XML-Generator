...
public partial class RulesTypeValidation : ExtensionBaseType
{
    ...
    private static XmlSerializer serializer;
        ...
        [System.Xml.Serialization.XmlElementAttribute("ItemAlternatives", typeof(AlternativesType), Order=0)]
        public virtual List<FuncBoolBaseType> Items { get; set; }
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out RulesTypeValidation obj, out System.Exception exception)
    {
        exception = null;
        obj = default(RulesTypeValidation);
        try
    ...
    public static RulesTypeValidation LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static RulesTypeValidation LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
