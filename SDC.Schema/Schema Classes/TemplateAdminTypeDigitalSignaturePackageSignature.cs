...
public partial class TemplateAdminTypeDigitalSignaturePackageSignature
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out TemplateAdminTypeDigitalSignaturePackageSignature obj, out System.Exception exception)
    {
        exception = null;
        obj = default(TemplateAdminTypeDigitalSignaturePackageSignature);
        try
    ...
    public static TemplateAdminTypeDigitalSignaturePackageSignature LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
