...
public partial class DataSourceTypeRDF_Store : DataStoreType
{
    ...
    private static XmlSerializer serializer;
        ...
        public virtual DataSourceTypeRDF_StoreSPARQL SPARQL { get; set; }
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out DataSourceTypeRDF_Store obj, out System.Exception exception)
    {
        exception = null;
        obj = default(DataSourceTypeRDF_Store);
        try
    ...
    public static DataSourceTypeRDF_Store LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static DataSourceTypeRDF_Store LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
