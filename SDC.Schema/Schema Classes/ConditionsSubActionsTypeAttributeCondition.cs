...
public partial class ConditionsSubActionsTypeAttributeCondition : GetItemAttribValuesType
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ConditionsSubActionsTypeAttributeCondition obj, out System.Exception exception)
    {
        exception = null;
        obj = default(ConditionsSubActionsTypeAttributeCondition);
        try
    ...
    public static ConditionsSubActionsTypeAttributeCondition LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static ConditionsSubActionsTypeAttributeCondition LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
