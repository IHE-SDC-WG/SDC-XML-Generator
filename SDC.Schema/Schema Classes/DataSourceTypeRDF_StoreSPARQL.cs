...
public partial class DataSourceTypeRDF_StoreSPARQL
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out DataSourceTypeRDF_StoreSPARQL obj, out System.Exception exception)
    {
        exception = null;
        obj = default(DataSourceTypeRDF_StoreSPARQL);
        try
    ...
    public static DataSourceTypeRDF_StoreSPARQL LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
