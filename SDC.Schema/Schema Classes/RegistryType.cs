...
public partial class RegistryType : ExtensionBaseType
{
    ...
    private static XmlSerializer serializer;
        ...
        public virtual RegistrySummaryType OriginalRegistry { get; set; }
        [System.Xml.Serialization.XmlElementAttribute(Order=1)]
        public virtual RegistrySummaryType CurrentRegistry { get; set; }
        [System.Xml.Serialization.XmlElementAttribute(Order=2)]
        public virtual RegisteredItemType RegistrationStatus { get; set; }
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out RegistryType obj, out System.Exception exception)
    {
        exception = null;
        obj = default(RegistryType);
        try
    ...
    public static RegistryType LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static RegistryType LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
