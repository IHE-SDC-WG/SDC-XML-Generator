...
public partial class TemplateTargetType : ExtensionBaseType
{
    ...
    private static XmlSerializer serializer;
        ...
        public virtual anyURI_Stype TargetItemID { get; set; }
        [System.Xml.Serialization.XmlElementAttribute(Order=1)]
        public virtual RichTextType TargetDisplayText { get; set; }
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out TemplateTargetType obj, out System.Exception exception)
    {
        exception = null;
        obj = default(TemplateTargetType);
        try
    ...
    public static TemplateTargetType LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static TemplateTargetType LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
