...
public partial class CallBoolFuncType : FuncBoolBaseType
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out CallBoolFuncType obj, out System.Exception exception)
    {
        exception = null;
        obj = default(CallBoolFuncType);
        try
    ...
    public static CallBoolFuncType LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static CallBoolFuncType LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
