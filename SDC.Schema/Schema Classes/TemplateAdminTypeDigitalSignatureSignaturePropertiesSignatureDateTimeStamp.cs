...
public partial class TemplateAdminTypeDigitalSignatureSignaturePropertiesSignatureDateTimeStamp
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out TemplateAdminTypeDigitalSignatureSignaturePropertiesSignatureDateTimeStamp obj, out System.Exception exception)
    {
        exception = null;
        obj = default(TemplateAdminTypeDigitalSignatureSignaturePropertiesSignatureDateTimeStamp);
        try
    ...
    public static TemplateAdminTypeDigitalSignatureSignaturePropertiesSignatureDateTimeStamp LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
