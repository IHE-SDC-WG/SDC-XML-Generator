...
public partial class DataSourceTypeDatabase : DataStoreType
{
    ...
    private static XmlSerializer serializer;
        ...
        public virtual SQL_Type SQL { get; set; }
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out DataSourceTypeDatabase obj, out System.Exception exception)
    {
        exception = null;
        obj = default(DataSourceTypeDatabase);
        try
    ...
    public static DataSourceTypeDatabase LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static DataSourceTypeDatabase LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
