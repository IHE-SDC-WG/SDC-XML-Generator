...
public partial class InterfaceTypeFields : BaseType
{
    ...
    private static XmlSerializer serializer;
        ...
        public virtual List<InterfaceTypeFieldsField> Field { get; set; }
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out InterfaceTypeFields obj, out System.Exception exception)
    {
        exception = null;
        obj = default(InterfaceTypeFields);
        try
    ...
    public static InterfaceTypeFields LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static InterfaceTypeFields LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
