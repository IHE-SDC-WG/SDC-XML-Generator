...
public partial class DataStoreTypeSecurityInfo : string_Stype
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out DataStoreTypeSecurityInfo obj, out System.Exception exception)
    {
        exception = null;
        obj = default(DataStoreTypeSecurityInfo);
        try
    ...
    public static DataStoreTypeSecurityInfo LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static DataStoreTypeSecurityInfo LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
