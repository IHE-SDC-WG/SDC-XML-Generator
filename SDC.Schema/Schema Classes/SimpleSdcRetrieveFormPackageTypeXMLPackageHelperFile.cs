...
public partial class SimpleSdcRetrieveFormPackageTypeXMLPackageHelperFile : ExtensionBaseType
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out SimpleSdcRetrieveFormPackageTypeXMLPackageHelperFile obj, out System.Exception exception)
    {
        exception = null;
        obj = default(SimpleSdcRetrieveFormPackageTypeXMLPackageHelperFile);
        try
    ...
    public static SimpleSdcRetrieveFormPackageTypeXMLPackageHelperFile LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static SimpleSdcRetrieveFormPackageTypeXMLPackageHelperFile LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
