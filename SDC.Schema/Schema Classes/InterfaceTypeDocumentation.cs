...
public partial class InterfaceTypeDocumentation : BaseType
{
    ...
    private static XmlSerializer serializer;
        ...
        public virtual List<FileType> File { get; set; }
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out InterfaceTypeDocumentation obj, out System.Exception exception)
    {
        exception = null;
        obj = default(InterfaceTypeDocumentation);
        try
    ...
    public static InterfaceTypeDocumentation LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static InterfaceTypeDocumentation LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
