...
public partial class TemplateAdminTypeDigitalSignatureSignaturePropertiesSignatureReason
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out TemplateAdminTypeDigitalSignatureSignaturePropertiesSignatureReason obj, out System.Exception exception)
    {
        exception = null;
        obj = default(TemplateAdminTypeDigitalSignatureSignaturePropertiesSignatureReason);
        try
    ...
    public static TemplateAdminTypeDigitalSignatureSignaturePropertiesSignatureReason LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
