...
public partial class TemplateAdminTypeDigitalSignatureSignaturePropertiesX_SignerPublicKey
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out TemplateAdminTypeDigitalSignatureSignaturePropertiesX_SignerPublicKey obj, out System.Exception exception)
    {
        exception = null;
        obj = default(TemplateAdminTypeDigitalSignatureSignaturePropertiesX_SignerPublicKey);
        try
    ...
    public static TemplateAdminTypeDigitalSignatureSignaturePropertiesX_SignerPublicKey LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
