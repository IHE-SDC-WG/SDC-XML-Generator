...
public partial class DataSourceType : ExtensionBaseType
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out DataSourceType obj, out System.Exception exception)
    {
        exception = null;
        obj = default(DataSourceType);
        try
    ...
    public static DataSourceType LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static DataSourceType LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
