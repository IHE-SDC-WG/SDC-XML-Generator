...
public partial class XPathType : string_Stype
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out XPathType obj, out System.Exception exception)
    {
        exception = null;
        obj = default(XPathType);
        try
    ...
    public static XPathType LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static XPathType LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
