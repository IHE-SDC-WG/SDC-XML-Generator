...
public partial class XQueryType : string_Stype
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out XQueryType obj, out System.Exception exception)
    {
        exception = null;
        obj = default(XQueryType);
        try
    ...
    public static XQueryType LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static XQueryType LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
