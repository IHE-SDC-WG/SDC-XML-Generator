...
public partial class TemplateAdminTypeDigitalSignatureSignaturePropertiesX_SignatureAlgorithm
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out TemplateAdminTypeDigitalSignatureSignaturePropertiesX_SignatureAlgorithm obj, out System.Exception exception)
    {
        exception = null;
        obj = default(TemplateAdminTypeDigitalSignatureSignaturePropertiesX_SignatureAlgorithm);
        try
    ...
    public static TemplateAdminTypeDigitalSignatureSignaturePropertiesX_SignatureAlgorithm LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
