...
public partial class TemplateAdminTypeDigitalSignatureSignaturePropertiesImage
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out TemplateAdminTypeDigitalSignatureSignaturePropertiesImage obj, out System.Exception exception)
    {
        exception = null;
        obj = default(TemplateAdminTypeDigitalSignatureSignaturePropertiesImage);
        try
    ...
    public static TemplateAdminTypeDigitalSignatureSignaturePropertiesImage LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
