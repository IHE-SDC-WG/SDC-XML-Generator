...
public partial class ConditionsSubActionsTypeScriptCondition : ScriptCodeBoolType
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ConditionsSubActionsTypeScriptCondition obj, out System.Exception exception)
    {
        exception = null;
        obj = default(ConditionsSubActionsTypeScriptCondition);
        try
    ...
    public static ConditionsSubActionsTypeScriptCondition LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static ConditionsSubActionsTypeScriptCondition LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
