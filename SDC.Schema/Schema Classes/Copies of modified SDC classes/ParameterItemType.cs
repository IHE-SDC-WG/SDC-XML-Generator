...
public partial class ParameterItemType : ExtensionBaseType
{
    ...
    /// </summary>
        [System.Xml.Serialization.XmlAttributeAttribute(DataType="NCName")]
        public virtual string sourceItemName { get; set; }
    /// <summary>
    ...
    /// </summary>
        ...
        public virtual string SourceItemAttribute { get; set; }
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ParameterItemType obj, out System.Exception exception)
    {
        exception = null;
        obj = default(ParameterItemType);
        try
    ...
    public static ParameterItemType LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static ParameterItemType LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
