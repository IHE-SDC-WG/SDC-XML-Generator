...
public partial class ConditionsSubActionsTypeIllegalSelectionTest : RuleSelectionTestType
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ConditionsSubActionsTypeIllegalSelectionTest obj, out System.Exception exception)
    {
        exception = null;
        obj = default(ConditionsSubActionsTypeIllegalSelectionTest);
        try
    ...
    public static ConditionsSubActionsTypeIllegalSelectionTest LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static ConditionsSubActionsTypeIllegalSelectionTest LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
