...
public partial class TemplateAdminTypeDigitalSignature : ExtensionBaseType
{
    ...
    private static XmlSerializer serializer;
        ...
        public virtual TemplateAdminTypeDigitalSignaturePackageSignature PackageSignature { get; set; }
        [System.Xml.Serialization.XmlElementAttribute(Order=1)]
        public virtual TemplateAdminTypeDigitalSignatureSignatureProperties SignatureProperties { get; set; }
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out TemplateAdminTypeDigitalSignature obj, out System.Exception exception)
    {
        exception = null;
        obj = default(TemplateAdminTypeDigitalSignature);
        try
    ...
    public static TemplateAdminTypeDigitalSignature LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static TemplateAdminTypeDigitalSignature LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
