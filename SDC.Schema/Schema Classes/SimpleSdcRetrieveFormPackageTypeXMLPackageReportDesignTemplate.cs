...
public partial class SimpleSdcRetrieveFormPackageTypeXMLPackageReportDesignTemplate : FormDesignType
{
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out SimpleSdcRetrieveFormPackageTypeXMLPackageReportDesignTemplate obj, out System.Exception exception)
    {
        exception = null;
        obj = default(SimpleSdcRetrieveFormPackageTypeXMLPackageReportDesignTemplate);
        try
    ...
    public static SimpleSdcRetrieveFormPackageTypeXMLPackageReportDesignTemplate LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static SimpleSdcRetrieveFormPackageTypeXMLPackageReportDesignTemplate LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
