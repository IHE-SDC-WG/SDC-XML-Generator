...
public partial class ConditionsSubActionsTypeIllegalSelectionSets : RuleSingleSelectionSetsType
{
    ...
    private static XmlSerializer serializer;
        ...
        public virtual ActionsType Actions { get; set; }
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ConditionsSubActionsTypeIllegalSelectionSets obj, out System.Exception exception)
    {
        exception = null;
        obj = default(ConditionsSubActionsTypeIllegalSelectionSets);
        try
    ...
    public static ConditionsSubActionsTypeIllegalSelectionSets LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static ConditionsSubActionsTypeIllegalSelectionSets LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
