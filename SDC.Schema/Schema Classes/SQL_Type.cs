...
public partial class SQL_Type : string_Stype
{
    ...
    private static XmlSerializer serializer;
        ...
        [System.Xml.Serialization.XmlAttributeAttribute()]
        public virtual string sqlDialectVersion { get; set; }
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out SQL_Type obj, out System.Exception exception)
    {
        exception = null;
        obj = default(SQL_Type);
        try
    ...
    public static SQL_Type LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static SQL_Type LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
