...
public partial class AlternativesType : FuncBoolBaseType
{
    ...
    /// </summary>
        ...
        public virtual int minAnswered { get; set; }
    /// <summary>
    /// @maxAnswered must be 0 or greater than or equal to @minAnswered.
    /// </summary>
        [System.Xml.Serialization.XmlAttributeAttribute()]
        [System.ComponentModel.DefaultValueAttribute(0)]
        public virtual int maxAnswered { get; set; }
    /// <summary>
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out AlternativesType obj, out System.Exception exception)
    {
        exception = null;
        obj = default(AlternativesType);
        try
    ...
    public static AlternativesType LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static AlternativesType LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
