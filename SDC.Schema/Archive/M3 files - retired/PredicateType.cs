...
/// <summary>
/// A Predicate is a structure that returns a Boolean value.  The Predicate has a left hand side (LHS) expression and a right hand side (RHS) expression.  The LHS and the RHS are compared with a comparison operator to return the Boolean value.
/// 
/// The LHS may compared against the RHS using a list (InList), evaluated as between 2 values (Between), or compared to a RHS expression (Compare) by an arithmetic comparison operator.
/// </summary>
