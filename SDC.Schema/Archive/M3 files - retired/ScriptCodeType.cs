...
public partial class ScriptCodeType : ExtensionBaseType
{
    ...
    public static bool Deserialize(string input, out ScriptCodeType obj, out System.Exception exception)
    {
        exception = null;
    ...
    public new static ScriptCodeType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ScriptCodeType)(Serializer.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static ScriptCodeType Deserialize(System.IO.Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, System.Text.Encoding encoding, out ScriptCodeType obj, out System.Exception exception)
    {
        exception = null;
        obj = default(ScriptCodeType);
        try
    ...
    public static bool LoadFromFile(string fileName, out ScriptCodeType obj, out System.Exception exception)
    {
    ...
    public static ScriptCodeType LoadFromFile(string fileName)
    {
        return LoadFromFile(fileName, System.Text.Encoding.UTF8);
    }
    
    public new static ScriptCodeType LoadFromFile(string fileName, System.Text.Encoding encoding)
    {
