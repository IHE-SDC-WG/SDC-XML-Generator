...
public partial class ListFieldType : ExtensionBaseType
{
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    private List<RuleIllegalSelectionSetsType> _illegalCoSelectedListItems;
    ...
    public virtual List<RuleIllegalSelectionSetsType> IllegalCoSelectedListItems
    {
        get
        {
    ...
    /// <summary>
    /// Minimum number of answer choices (list items) that must be selected by the user.  Default value is 1, meaning that the question is single-select (QS)
    /// 
