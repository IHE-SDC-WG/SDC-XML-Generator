...
[DataContractAttribute(Name="gMonthDay_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class gMonthDay_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out gMonthDay_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static gMonthDay_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((gMonthDay_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static gMonthDay_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out gMonthDay_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(gMonthDay_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this gMonthDay_Stype object
    /// </summary>
    public virtual gMonthDay_Stype Clone()
    {
        return ((gMonthDay_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
