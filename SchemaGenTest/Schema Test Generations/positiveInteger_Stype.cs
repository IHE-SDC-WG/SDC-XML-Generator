...
[DataContractAttribute(Name="positiveInteger_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class positiveInteger_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out positiveInteger_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static positiveInteger_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((positiveInteger_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static positiveInteger_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out positiveInteger_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(positiveInteger_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this positiveInteger_Stype object
    /// </summary>
    public virtual positiveInteger_Stype Clone()
    {
        return ((positiveInteger_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
