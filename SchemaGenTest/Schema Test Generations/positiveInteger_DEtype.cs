...
[DataContractAttribute(Name="positiveInteger_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class positiveInteger_DEtype : positiveInteger_Stype
{
    ...
    public static bool Deserialize(string input, out positiveInteger_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static positiveInteger_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((positiveInteger_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static positiveInteger_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out positiveInteger_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(positiveInteger_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this positiveInteger_DEtype object
    /// </summary>
    public virtual positiveInteger_DEtype Clone()
    {
        return ((positiveInteger_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
