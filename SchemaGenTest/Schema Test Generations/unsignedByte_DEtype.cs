...
[DataContractAttribute(Name="unsignedByte_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class unsignedByte_DEtype : unsignedByte_Stype
{
    ...
    public static bool Deserialize(string input, out unsignedByte_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static unsignedByte_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((unsignedByte_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static unsignedByte_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out unsignedByte_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(unsignedByte_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this unsignedByte_DEtype object
    /// </summary>
    public virtual unsignedByte_DEtype Clone()
    {
        return ((unsignedByte_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
