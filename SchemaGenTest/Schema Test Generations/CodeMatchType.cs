...
[DataContractAttribute(Name="CodeMatchType", Namespace="http://healthIT.gov/sdc")]
public partial class CodeMatchType : BaseType
{
    ...
    public static bool Deserialize(string input, out CodeMatchType obj, out Exception exception)
    {
        exception = null;
    ...
    public static CodeMatchType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out CodeMatchType obj, out Exception exception)
    {
        exception = null;
        obj = default(CodeMatchType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this CodeMatchType object
    /// </summary>
    public virtual CodeMatchType Clone()
    {
        return ((CodeMatchType)(MemberwiseClone()));
    }
    #endregion
}
}
