...
[DataContractAttribute(Name="dayTimeDuration_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class dayTimeDuration_DEtype : dayTimeDuration_Stype
{
    ...
    public static bool Deserialize(string input, out dayTimeDuration_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public static dayTimeDuration_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out dayTimeDuration_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(dayTimeDuration_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this dayTimeDuration_DEtype object
    /// </summary>
    public virtual dayTimeDuration_DEtype Clone()
    {
        return ((dayTimeDuration_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
