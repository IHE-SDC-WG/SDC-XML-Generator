...
[DataContractAttribute(Name="int_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class int_DEtype : int_Stype
{
    ...
    public static bool Deserialize(string input, out int_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static int_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((int_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static int_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out int_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(int_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this int_DEtype object
    /// </summary>
    public virtual int_DEtype Clone()
    {
        return ((int_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
