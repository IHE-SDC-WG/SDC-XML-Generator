...
[DataContractAttribute(Name="nonNegativeInteger_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class nonNegativeInteger_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out nonNegativeInteger_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public static nonNegativeInteger_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out nonNegativeInteger_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(nonNegativeInteger_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this nonNegativeInteger_Stype object
    /// </summary>
    public virtual nonNegativeInteger_Stype Clone()
    {
        return ((nonNegativeInteger_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
