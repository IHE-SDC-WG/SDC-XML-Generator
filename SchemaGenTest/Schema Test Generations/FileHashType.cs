...
[DataContractAttribute(Name="FileHashType", Namespace="http://healthIT.gov/sdc")]
public partial class FileHashType : string_Stype
{
    ...
    public static bool Deserialize(string input, out FileHashType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static FileHashType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((FileHashType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static FileHashType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out FileHashType obj, out Exception exception)
    {
        exception = null;
        obj = default(FileHashType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this FileHashType object
    /// </summary>
    public virtual FileHashType Clone()
    {
        return ((FileHashType)(MemberwiseClone()));
    }
    #endregion
}
}
