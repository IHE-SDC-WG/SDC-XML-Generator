...
[DataContractAttribute(Name="string_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class string_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out string_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static string_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((string_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static string_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out string_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(string_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this string_Stype object
    /// </summary>
    public virtual string_Stype Clone()
    {
        return ((string_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
