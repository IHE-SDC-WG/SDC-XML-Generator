...
[DataContractAttribute(Name="negativeInteger_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class negativeInteger_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out negativeInteger_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static negativeInteger_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((negativeInteger_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static negativeInteger_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out negativeInteger_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(negativeInteger_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this negativeInteger_Stype object
    /// </summary>
    public virtual negativeInteger_Stype Clone()
    {
        return ((negativeInteger_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
