...
[DataContractAttribute(Name="ContactType", Namespace="http://healthIT.gov/sdc")]
public partial class ContactType : ExtensionBaseType
{
    ...
    [XmlElementAttribute("Organization", typeof(OrganizationType), Order=0)]
    [XmlElementAttribute("Person", typeof(PersonType), Order=0)]
    [DataMemberAttribute(Name="Organization", Order=0)]
    ...
    public static bool Deserialize(string input, out ContactType obj, out Exception exception)
    {
        exception = null;
    ...
    public static ContactType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out ContactType obj, out Exception exception)
    {
        exception = null;
        obj = default(ContactType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this ContactType object
    /// </summary>
    public virtual ContactType Clone()
    {
        return ((ContactType)(MemberwiseClone()));
    }
    #endregion
}
}
