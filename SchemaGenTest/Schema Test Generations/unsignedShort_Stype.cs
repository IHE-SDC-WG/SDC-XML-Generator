...
[DataContractAttribute(Name="unsignedShort_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class unsignedShort_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out unsignedShort_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public static unsignedShort_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out unsignedShort_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(unsignedShort_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this unsignedShort_Stype object
    /// </summary>
    public virtual unsignedShort_Stype Clone()
    {
        return ((unsignedShort_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
