...
[DataContractAttribute(Name="ActInjectType", Namespace="http://healthIT.gov/sdc")]
public partial class ActInjectType : InjectFormType
{
    ...
    public static bool Deserialize(string input, out ActInjectType obj, out Exception exception)
    {
        exception = null;
    ...
    public static ActInjectType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out ActInjectType obj, out Exception exception)
    {
        exception = null;
        obj = default(ActInjectType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this ActInjectType object
    /// </summary>
    public virtual ActInjectType Clone()
    {
        return ((ActInjectType)(MemberwiseClone()));
    }
    #endregion
}
}
