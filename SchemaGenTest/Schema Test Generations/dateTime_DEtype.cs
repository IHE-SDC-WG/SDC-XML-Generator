...
[DataContractAttribute(Name="dateTime_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class dateTime_DEtype : dateTime_Stype
{
    ...
    public static bool Deserialize(string input, out dateTime_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static dateTime_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((dateTime_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static dateTime_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out dateTime_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(dateTime_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this dateTime_DEtype object
    /// </summary>
    public virtual dateTime_DEtype Clone()
    {
        return ((dateTime_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
