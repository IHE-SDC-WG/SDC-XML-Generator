...
[DataContractAttribute(Name="QuestionItemType", Namespace="http://healthIT.gov/sdc")]
public partial class QuestionItemType : QuestionItemBaseType
{
    ...
    public static bool Deserialize(string input, out QuestionItemType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static QuestionItemType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((QuestionItemType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static QuestionItemType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out QuestionItemType obj, out Exception exception)
    {
        exception = null;
        obj = default(QuestionItemType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this QuestionItemType object
    /// </summary>
    public virtual QuestionItemType Clone()
    {
        return ((QuestionItemType)(MemberwiseClone()));
    }
    #endregion
}
}
