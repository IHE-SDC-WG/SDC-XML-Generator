...
[DataContractAttribute(Name="hexBinary_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class hexBinary_DEtype : hexBinary_Stype
{
    ...
    public static bool Deserialize(string input, out hexBinary_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static hexBinary_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((hexBinary_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static hexBinary_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out hexBinary_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(hexBinary_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this hexBinary_DEtype object
    /// </summary>
    public virtual hexBinary_DEtype Clone()
    {
        return ((hexBinary_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
