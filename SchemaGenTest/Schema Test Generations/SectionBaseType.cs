...
[DataContractAttribute(Name="SectionBaseType", Namespace="http://healthIT.gov/sdc")]
public partial class SectionBaseType : RepeatingType
{
    ...
    public static bool Deserialize(string input, out SectionBaseType obj, out Exception exception)
    {
        exception = null;
    ...
    public static SectionBaseType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out SectionBaseType obj, out Exception exception)
    {
        exception = null;
        obj = default(SectionBaseType);
        try
    ...
    /// </summary>
    public virtual SectionBaseType Clone()
    {
        return ((SectionBaseType)(MemberwiseClone()));
    }
    #endregion
}
}
