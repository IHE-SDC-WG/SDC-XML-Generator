...
[DataContractAttribute(Name="yearMonthDuration_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class yearMonthDuration_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out yearMonthDuration_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static yearMonthDuration_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((yearMonthDuration_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static yearMonthDuration_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out yearMonthDuration_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(yearMonthDuration_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this yearMonthDuration_Stype object
    /// </summary>
    public virtual yearMonthDuration_Stype Clone()
    {
        return ((yearMonthDuration_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
