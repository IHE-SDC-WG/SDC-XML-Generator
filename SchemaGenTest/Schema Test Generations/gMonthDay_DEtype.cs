...
[DataContractAttribute(Name="gMonthDay_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class gMonthDay_DEtype : gMonthDay_Stype
{
    ...
    [XmlAttributeAttribute(DataType="gMonthDay")]
    [DataMember]
    ...
    public static bool Deserialize(string input, out gMonthDay_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static gMonthDay_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((gMonthDay_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static gMonthDay_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out gMonthDay_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(gMonthDay_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this gMonthDay_DEtype object
    /// </summary>
    public virtual gMonthDay_DEtype Clone()
    {
        return ((gMonthDay_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
