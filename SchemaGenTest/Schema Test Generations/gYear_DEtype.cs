...
[DataContractAttribute(Name="gYear_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class gYear_DEtype : gYear_Stype
{
    ...
    [XmlAttributeAttribute(DataType="gYear")]
    [DataMember]
    ...
    public static bool Deserialize(string input, out gYear_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static gYear_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((gYear_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static gYear_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out gYear_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(gYear_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this gYear_DEtype object
    /// </summary>
    public virtual gYear_DEtype Clone()
    {
        return ((gYear_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
