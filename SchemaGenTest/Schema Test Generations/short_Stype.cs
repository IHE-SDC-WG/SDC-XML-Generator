...
[DataContractAttribute(Name="short_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class short_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out short_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static short_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((short_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static short_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out short_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(short_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this short_Stype object
    /// </summary>
    public virtual short_Stype Clone()
    {
        return ((short_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
