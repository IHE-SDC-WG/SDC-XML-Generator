...
[DataContractAttribute(Name="long_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class long_DEtype : long_Stype
{
    ...
    public static bool Deserialize(string input, out long_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static long_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((long_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static long_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out long_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(long_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this long_DEtype object
    /// </summary>
    public virtual long_DEtype Clone()
    {
        return ((long_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
