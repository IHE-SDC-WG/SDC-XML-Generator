...
[DataContractAttribute(Name="time_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class time_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out time_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static time_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((time_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static time_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out time_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(time_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this time_Stype object
    /// </summary>
    public virtual time_Stype Clone()
    {
        return ((time_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
