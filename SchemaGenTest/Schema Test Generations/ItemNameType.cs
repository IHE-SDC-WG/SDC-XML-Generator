...
[DataContractAttribute(Name="ItemNameType", Namespace="http://healthIT.gov/sdc")]
public partial class ItemNameType : BaseType
{
    ...
    public static bool Deserialize(string input, out ItemNameType obj, out Exception exception)
    {
        exception = null;
    ...
    public static ItemNameType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out ItemNameType obj, out Exception exception)
    {
        exception = null;
        obj = default(ItemNameType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this ItemNameType object
    /// </summary>
    public virtual ItemNameType Clone()
    {
        return ((ItemNameType)(MemberwiseClone()));
    }
    #endregion
}
}
