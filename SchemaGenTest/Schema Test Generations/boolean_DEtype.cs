...
[DataContractAttribute(Name="boolean_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class boolean_DEtype : boolean_Stype
{
    ...
    public static bool Deserialize(string input, out boolean_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static boolean_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((boolean_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static boolean_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out boolean_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(boolean_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this boolean_DEtype object
    /// </summary>
    public virtual boolean_DEtype Clone()
    {
        return ((boolean_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
