...
[DataContractAttribute(Name="dateTimeStamp_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class dateTimeStamp_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out dateTimeStamp_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static dateTimeStamp_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((dateTimeStamp_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static dateTimeStamp_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out dateTimeStamp_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(dateTimeStamp_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this dateTimeStamp_Stype object
    /// </summary>
    public virtual dateTimeStamp_Stype Clone()
    {
        return ((dateTimeStamp_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
