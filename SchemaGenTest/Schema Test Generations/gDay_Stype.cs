...
[DataContractAttribute(Name="gDay_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class gDay_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out gDay_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static gDay_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((gDay_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static gDay_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out gDay_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(gDay_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this gDay_Stype object
    /// </summary>
    public virtual gDay_Stype Clone()
    {
        return ((gDay_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
