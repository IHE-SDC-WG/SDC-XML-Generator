...
[DataContractAttribute(Name="decimal_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class decimal_DEtype : decimal_Stype
{
    ...
    public static bool Deserialize(string input, out decimal_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static decimal_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((decimal_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static decimal_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out decimal_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(decimal_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this decimal_DEtype object
    /// </summary>
    public virtual decimal_DEtype Clone()
    {
        return ((decimal_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
