...
[DataContractAttribute(Name="short_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class short_DEtype : short_Stype
{
    ...
    public static bool Deserialize(string input, out short_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static short_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((short_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static short_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out short_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(short_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this short_DEtype object
    /// </summary>
    public virtual short_DEtype Clone()
    {
        return ((short_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
