...
[DataContractAttribute(Name="unsignedLong_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class unsignedLong_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out unsignedLong_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static unsignedLong_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((unsignedLong_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static unsignedLong_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out unsignedLong_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(unsignedLong_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this unsignedLong_Stype object
    /// </summary>
    public virtual unsignedLong_Stype Clone()
    {
        return ((unsignedLong_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
