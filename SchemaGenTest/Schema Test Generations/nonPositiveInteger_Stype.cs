...
[DataContractAttribute(Name="nonPositiveInteger_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class nonPositiveInteger_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out nonPositiveInteger_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static nonPositiveInteger_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((nonPositiveInteger_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static nonPositiveInteger_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out nonPositiveInteger_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(nonPositiveInteger_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this nonPositiveInteger_Stype object
    /// </summary>
    public virtual nonPositiveInteger_Stype Clone()
    {
        return ((nonPositiveInteger_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
