...
[DataContractAttribute(Name="float_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class float_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out float_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public static float_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out float_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(float_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this float_Stype object
    /// </summary>
    public virtual float_Stype Clone()
    {
        return ((float_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
