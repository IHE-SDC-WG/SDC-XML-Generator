...
[DataContractAttribute(Name="integer_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class integer_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out integer_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public static integer_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out integer_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(integer_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this integer_Stype object
    /// </summary>
    public virtual integer_Stype Clone()
    {
        return ((integer_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
