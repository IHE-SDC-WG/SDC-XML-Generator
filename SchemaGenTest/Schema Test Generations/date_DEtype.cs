...
[DataContractAttribute(Name="date_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class date_DEtype : date_Stype
{
    ...
    public static bool Deserialize(string input, out date_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static date_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((date_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static date_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out date_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(date_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this date_DEtype object
    /// </summary>
    public virtual date_DEtype Clone()
    {
        return ((date_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
