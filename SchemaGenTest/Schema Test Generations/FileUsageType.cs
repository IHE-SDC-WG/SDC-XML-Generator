...
[DataContractAttribute(Name="FileUsageType", Namespace="http://healthIT.gov/sdc")]
public partial class FileUsageType : ExtensionBaseType
{
    
    [EditorBrowsable(EditorBrowsableState.Never)]
    private BindingList<CodingType> _included;
    
    [EditorBrowsable(EditorBrowsableState.Never)]
    private BindingList<CodingType> _excluded;
    ...
    /// </summary>
    [XmlElementAttribute("Included", Order=0)]
    [DataMemberAttribute(Order=0)]
    public virtual BindingList<CodingType> Included
    {
        get
        {
            return _included;
    ...
    /// </summary>
    [XmlElementAttribute("Excluded", Order=1)]
    [DataMemberAttribute(Order=1)]
    public virtual BindingList<CodingType> Excluded
    {
        get
        {
            return _excluded;
    ...
    public static bool Deserialize(string input, out FileUsageType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static FileUsageType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((FileUsageType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static FileUsageType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out FileUsageType obj, out Exception exception)
    {
        exception = null;
        obj = default(FileUsageType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this FileUsageType object
    /// </summary>
    public virtual FileUsageType Clone()
    {
        return ((FileUsageType)(MemberwiseClone()));
    }
    #endregion
}
}
