...
[DataContractAttribute(Name="ApprovalType", Namespace="http://healthIT.gov/sdc")]
public partial class ApprovalType : ExtensionBaseType
{
    
    [EditorBrowsable(EditorBrowsableState.Never)]
    private BindingList<ContactType> _approvalContact;
    ...
    [XmlElementAttribute("ApprovalContact", Order=0)]
    [DataMemberAttribute(Order=0)]
    public virtual BindingList<ContactType> ApprovalContact
    {
        get
        {
        ...
        set
        {
            if ((_approvalContact == value))
            {
                return;
            }
            if (((_approvalContact == null) 
                        || (_approvalContact.Equals(value) != true)))
            {
                _approvalContact = value;
                OnPropertyChanged("ApprovalContact", value);
            }
        }
    }
    ...
    public static bool Deserialize(string input, out ApprovalType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static ApprovalType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ApprovalType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static ApprovalType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out ApprovalType obj, out Exception exception)
    {
        exception = null;
        obj = default(ApprovalType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this ApprovalType object
    /// </summary>
    public virtual ApprovalType Clone()
    {
        return ((ApprovalType)(MemberwiseClone()));
    }
    #endregion
}
}
