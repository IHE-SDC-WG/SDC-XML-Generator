...
[DataContractAttribute(Name="HTML_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class HTML_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out HTML_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static HTML_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((HTML_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static HTML_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out HTML_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(HTML_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this HTML_Stype object
    /// </summary>
    public virtual HTML_Stype Clone()
    {
        return ((HTML_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
