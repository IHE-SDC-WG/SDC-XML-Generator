...
[DataContractAttribute(Name="nonNegativeInteger_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class nonNegativeInteger_DEtype : nonNegativeInteger_Stype
{
    ...
    public static bool Deserialize(string input, out nonNegativeInteger_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static nonNegativeInteger_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((nonNegativeInteger_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static nonNegativeInteger_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out nonNegativeInteger_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(nonNegativeInteger_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this nonNegativeInteger_DEtype object
    /// </summary>
    public virtual nonNegativeInteger_DEtype Clone()
    {
        return ((nonNegativeInteger_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
