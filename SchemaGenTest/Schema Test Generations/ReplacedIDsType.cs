...
[DataContractAttribute(Name="ReplacedIDsType", Namespace="http://healthIT.gov/sdc")]
public partial class ReplacedIDsType : BaseType
{
    
    [EditorBrowsable(EditorBrowsableState.Never)]
    private BindingList<anyURI_Stype> _replacedID;
    
    private static XmlSerializer serializer;
    
    private ObjectChangeTracker changeTrackerField;
    
    [XmlElementAttribute("ReplacedID", Order=0)]
    [DataMemberAttribute(Order=0)]
    public virtual BindingList<anyURI_Stype> ReplacedID
    {
        get
        {
            return _replacedID;
    ...
    public static bool Deserialize(string input, out ReplacedIDsType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static ReplacedIDsType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ReplacedIDsType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static ReplacedIDsType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out ReplacedIDsType obj, out Exception exception)
    {
        exception = null;
        obj = default(ReplacedIDsType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this ReplacedIDsType object
    /// </summary>
    public virtual ReplacedIDsType Clone()
    {
        return ((ReplacedIDsType)(MemberwiseClone()));
    }
    #endregion
}
}
