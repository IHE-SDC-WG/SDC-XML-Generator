...
[DataContractAttribute(Name="unsignedInt_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class unsignedInt_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out unsignedInt_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static unsignedInt_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((unsignedInt_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static unsignedInt_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out unsignedInt_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(unsignedInt_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this unsignedInt_Stype object
    /// </summary>
    public virtual unsignedInt_Stype Clone()
    {
        return ((unsignedInt_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
