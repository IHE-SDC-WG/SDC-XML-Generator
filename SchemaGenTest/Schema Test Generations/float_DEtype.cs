...
[DataContractAttribute(Name="float_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class float_DEtype : float_Stype
{
    ...
    public static bool Deserialize(string input, out float_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public static float_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out float_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(float_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this float_DEtype object
    /// </summary>
    public virtual float_DEtype Clone()
    {
        return ((float_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
