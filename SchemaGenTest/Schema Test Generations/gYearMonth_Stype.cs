...
[DataContractAttribute(Name="gYearMonth_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class gYearMonth_Stype : BaseType
{
    ...
    [XmlAttributeAttribute(DataType="gYearMonth")]
    [DataMember]
    ...
    public static bool Deserialize(string input, out gYearMonth_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static gYearMonth_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((gYearMonth_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static gYearMonth_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out gYearMonth_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(gYearMonth_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this gYearMonth_Stype object
    /// </summary>
    public virtual gYearMonth_Stype Clone()
    {
        return ((gYearMonth_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
