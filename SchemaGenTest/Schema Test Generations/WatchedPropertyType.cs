...
[DataContractAttribute(Name="WatchedPropertyType", Namespace="http://healthIT.gov/sdc")]
public partial class WatchedPropertyType : IfType
{
    ...
    public static bool Deserialize(string input, out WatchedPropertyType obj, out Exception exception)
    {
        exception = null;
    ...
    public static WatchedPropertyType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out WatchedPropertyType obj, out Exception exception)
    {
        exception = null;
        obj = default(WatchedPropertyType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this WatchedPropertyType object
    /// </summary>
    public virtual WatchedPropertyType Clone()
    {
        return ((WatchedPropertyType)(MemberwiseClone()));
    }
    #endregion
}
}
