...
[DataContractAttribute(Name="ProvenanceType", Namespace="http://healthIT.gov/sdc")]
public partial class ProvenanceType : ExtensionBaseType
{
    
    [EditorBrowsable(EditorBrowsableState.Never)]
    private BindingList<FileType> _replacedFile;
    
    private static XmlSerializer serializer;
    
    private ObjectChangeTracker changeTrackerField;
    
    [XmlElementAttribute("ReplacedFile", Order=0)]
    [DataMemberAttribute(Order=0)]
    public virtual BindingList<FileType> ReplacedFile
    {
        get
        {
    ...
    public static bool Deserialize(string input, out ProvenanceType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static ProvenanceType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ProvenanceType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static ProvenanceType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out ProvenanceType obj, out Exception exception)
    {
        exception = null;
        obj = default(ProvenanceType);
        try
    ...
    /// </summary>
    public virtual ProvenanceType Clone()
    {
        return ((ProvenanceType)(MemberwiseClone()));
    }
    #endregion
}
}
