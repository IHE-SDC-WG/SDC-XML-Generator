...
[DataContractAttribute(Name="unsignedByte_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class unsignedByte_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out unsignedByte_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static unsignedByte_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((unsignedByte_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static unsignedByte_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out unsignedByte_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(unsignedByte_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this unsignedByte_Stype object
    /// </summary>
    public virtual unsignedByte_Stype Clone()
    {
        return ((unsignedByte_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
