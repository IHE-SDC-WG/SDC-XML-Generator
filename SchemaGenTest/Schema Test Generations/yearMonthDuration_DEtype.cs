...
[DataContractAttribute(Name="yearMonthDuration_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class yearMonthDuration_DEtype : yearMonthDuration_Stype
{
    ...
    public static bool Deserialize(string input, out yearMonthDuration_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static yearMonthDuration_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((yearMonthDuration_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static yearMonthDuration_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out yearMonthDuration_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(yearMonthDuration_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this yearMonthDuration_DEtype object
    /// </summary>
    public virtual yearMonthDuration_DEtype Clone()
    {
        return ((yearMonthDuration_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
