...
[DataContractAttribute(Name="ActSendMessageType", Namespace="http://healthIT.gov/sdc")]
public partial class ActSendMessageType : RichTextType
{
    ...
    [XmlElementAttribute("Email", typeof(EmailAddressType), Order=1)]
    [XmlElementAttribute("Fax", typeof(PhoneNumberType), Order=1)]
    [XmlElementAttribute("WebService", typeof(WebServiceType), Order=1)]
    [DataMemberAttribute(Name="Email", Order=1)]
    ...
    public static bool Deserialize(string input, out ActSendMessageType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static ActSendMessageType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ActSendMessageType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static ActSendMessageType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out ActSendMessageType obj, out Exception exception)
    {
        exception = null;
        obj = default(ActSendMessageType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this ActSendMessageType object
    /// </summary>
    public virtual ActSendMessageType Clone()
    {
        return ((ActSendMessageType)(MemberwiseClone()));
    }
    #endregion
}
}
