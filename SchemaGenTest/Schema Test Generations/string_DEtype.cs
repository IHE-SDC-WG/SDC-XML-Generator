...
[DataContractAttribute(Name="string_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class string_DEtype : string_Stype
{
    ...
    public static bool Deserialize(string input, out string_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static string_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((string_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static string_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out string_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(string_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this string_DEtype object
    /// </summary>
    public virtual string_DEtype Clone()
    {
        return ((string_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
