...
[DataContractAttribute(Name="gYearMonth_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class gYearMonth_DEtype : gYearMonth_Stype
{
    ...
    public static bool Deserialize(string input, out gYearMonth_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static gYearMonth_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((gYearMonth_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static gYearMonth_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out gYearMonth_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(gYearMonth_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this gYearMonth_DEtype object
    /// </summary>
    public virtual gYearMonth_DEtype Clone()
    {
        return ((gYearMonth_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
