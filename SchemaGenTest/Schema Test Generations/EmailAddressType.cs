...
[DataContractAttribute(Name="EmailAddressType", Namespace="http://healthIT.gov/sdc")]
public partial class EmailAddressType : BaseType
{
    ...
    public static bool Deserialize(string input, out EmailAddressType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static EmailAddressType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((EmailAddressType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static EmailAddressType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out EmailAddressType obj, out Exception exception)
    {
        exception = null;
        obj = default(EmailAddressType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this EmailAddressType object
    /// </summary>
    public virtual EmailAddressType Clone()
    {
        return ((EmailAddressType)(MemberwiseClone()));
    }
    #endregion
}
}
