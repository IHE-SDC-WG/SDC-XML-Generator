...
[DataContractAttribute(Name="time_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class time_DEtype : time_Stype
{
    ...
    public static bool Deserialize(string input, out time_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static time_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((time_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static time_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out time_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(time_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this time_DEtype object
    /// </summary>
    public virtual time_DEtype Clone()
    {
        return ((time_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
