...
[DataContractAttribute(Name="unsignedShort_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class unsignedShort_DEtype : unsignedShort_Stype
{
    ...
    public static bool Deserialize(string input, out unsignedShort_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static unsignedShort_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((unsignedShort_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static unsignedShort_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out unsignedShort_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(unsignedShort_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this unsignedShort_DEtype object
    /// </summary>
    public virtual unsignedShort_DEtype Clone()
    {
        return ((unsignedShort_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
