...
[DataContractAttribute(Name="gMonth_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class gMonth_DEtype : gMonth_Stype
{
    ...
    [XmlAttributeAttribute(DataType="gMonth")]
    [DataMember]
    ...
    public static bool Deserialize(string input, out gMonth_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static gMonth_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((gMonth_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static gMonth_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out gMonth_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(gMonth_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this gMonth_DEtype object
    /// </summary>
    public virtual gMonth_DEtype Clone()
    {
        return ((gMonth_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
