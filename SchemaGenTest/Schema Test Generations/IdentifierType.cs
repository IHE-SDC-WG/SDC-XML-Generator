...
[DataContractAttribute(Name="IdentifierType", Namespace="http://healthIT.gov/sdc")]
public partial class IdentifierType : ExtensionBaseType
{
    ...
    public static bool Deserialize(string input, out IdentifierType obj, out Exception exception)
    {
        exception = null;
    ...
    public static IdentifierType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out IdentifierType obj, out Exception exception)
    {
        exception = null;
        obj = default(IdentifierType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this IdentifierType object
    /// </summary>
    public virtual IdentifierType Clone()
    {
        return ((IdentifierType)(MemberwiseClone()));
    }
    #endregion
}
}
