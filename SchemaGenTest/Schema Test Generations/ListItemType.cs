...
[DataContractAttribute(Name="ListItemType", Namespace="http://healthIT.gov/sdc")]
public partial class ListItemType : ListItemBaseType
{
    ...
    public static bool Deserialize(string input, out ListItemType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static ListItemType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ListItemType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static ListItemType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out ListItemType obj, out Exception exception)
    {
        exception = null;
        obj = default(ListItemType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this ListItemType object
    /// </summary>
    public virtual ListItemType Clone()
    {
        return ((ListItemType)(MemberwiseClone()));
    }
    #endregion
}
}
