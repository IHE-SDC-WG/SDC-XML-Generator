...
[DataContractAttribute(Name="TargetItemIDType", Namespace="http://healthIT.gov/sdc")]
public partial class TargetItemIDType : anyURI_Stype
{
    ...
    public static bool Deserialize(string input, out TargetItemIDType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static TargetItemIDType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((TargetItemIDType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static TargetItemIDType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out TargetItemIDType obj, out Exception exception)
    {
        exception = null;
        obj = default(TargetItemIDType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this TargetItemIDType object
    /// </summary>
    public virtual TargetItemIDType Clone()
    {
        return ((TargetItemIDType)(MemberwiseClone()));
    }
    #endregion
}
}
