...
[DataContractAttribute(Name="unsignedInt_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class unsignedInt_DEtype : unsignedInt_Stype
{
    ...
    public static bool Deserialize(string input, out unsignedInt_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static unsignedInt_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((unsignedInt_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static unsignedInt_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out unsignedInt_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(unsignedInt_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this unsignedInt_DEtype object
    /// </summary>
    public virtual unsignedInt_DEtype Clone()
    {
        return ((unsignedInt_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
