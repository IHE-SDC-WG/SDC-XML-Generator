...
[DataContractAttribute(Name="SubmissionRuleType", Namespace="http://healthIT.gov/sdc")]
public partial class SubmissionRuleType : ExtensionBaseType
{
    
    [EditorBrowsable(EditorBrowsableState.Never)]
    private BindingList<DestinationType> _destination;
    ...
    [XmlElementAttribute("Destination", Order=0)]
    [DataMemberAttribute(Order=0)]
    public virtual BindingList<DestinationType> Destination
    {
        get
        {
            return _destination;
    ...
    public static bool Deserialize(string input, out SubmissionRuleType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static SubmissionRuleType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((SubmissionRuleType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static SubmissionRuleType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out SubmissionRuleType obj, out Exception exception)
    {
        exception = null;
        obj = default(SubmissionRuleType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this SubmissionRuleType object
    /// </summary>
    public virtual SubmissionRuleType Clone()
    {
        return ((SubmissionRuleType)(MemberwiseClone()));
    }
    #endregion
}
}
