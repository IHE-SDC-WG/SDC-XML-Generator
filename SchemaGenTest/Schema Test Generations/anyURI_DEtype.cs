...
[DataContractAttribute(Name="anyURI_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class anyURI_DEtype : anyURI_Stype
{
    ...
    public static bool Deserialize(string input, out anyURI_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static anyURI_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((anyURI_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static anyURI_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out anyURI_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(anyURI_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this anyURI_DEtype object
    /// </summary>
    public virtual anyURI_DEtype Clone()
    {
        return ((anyURI_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
