...
[DataContractAttribute(Name="ActSaveResponsesType", Namespace="http://healthIT.gov/sdc")]
public partial class ActSaveResponsesType : ExtensionBaseType
{
    ...
    public static bool Deserialize(string input, out ActSaveResponsesType obj, out Exception exception)
    {
        exception = null;
    ...
    public static ActSaveResponsesType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out ActSaveResponsesType obj, out Exception exception)
    {
        exception = null;
        obj = default(ActSaveResponsesType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this ActSaveResponsesType object
    /// </summary>
    public virtual ActSaveResponsesType Clone()
    {
        return ((ActSaveResponsesType)(MemberwiseClone()));
    }
    #endregion
}
}
