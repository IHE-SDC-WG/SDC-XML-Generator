...
[DataContractAttribute(Name="TargetItemNameType", Namespace="http://healthIT.gov/sdc")]
public partial class TargetItemNameType : BaseType
{
    ...
    public static bool Deserialize(string input, out TargetItemNameType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static TargetItemNameType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((TargetItemNameType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static TargetItemNameType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out TargetItemNameType obj, out Exception exception)
    {
        exception = null;
        obj = default(TargetItemNameType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this TargetItemNameType object
    /// </summary>
    public virtual TargetItemNameType Clone()
    {
        return ((TargetItemNameType)(MemberwiseClone()));
    }
    #endregion
}
}
