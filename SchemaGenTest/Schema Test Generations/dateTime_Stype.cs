...
[DataContractAttribute(Name="dateTime_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class dateTime_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out dateTime_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static dateTime_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((dateTime_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static dateTime_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out dateTime_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(dateTime_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this dateTime_Stype object
    /// </summary>
    public virtual dateTime_Stype Clone()
    {
        return ((dateTime_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
