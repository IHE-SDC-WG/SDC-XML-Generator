...
[DataContractAttribute(Name="XML_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class XML_DEtype : XML_Stype
{
    ...
    public static bool Deserialize(string input, out XML_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public static XML_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out XML_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(XML_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this XML_DEtype object
    /// </summary>
    public virtual XML_DEtype Clone()
    {
        return ((XML_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
