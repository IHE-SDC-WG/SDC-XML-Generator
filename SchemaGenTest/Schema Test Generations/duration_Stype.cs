...
[DataContractAttribute(Name="duration_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class duration_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out duration_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static duration_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((duration_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static duration_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out duration_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(duration_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this duration_Stype object
    /// </summary>
    public virtual duration_Stype Clone()
    {
        return ((duration_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
