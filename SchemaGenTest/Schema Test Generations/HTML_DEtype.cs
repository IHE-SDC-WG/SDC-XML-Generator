...
[DataContractAttribute(Name="HTML_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class HTML_DEtype : HTML_Stype
{
    ...
    public static bool Deserialize(string input, out HTML_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static HTML_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((HTML_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static HTML_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out HTML_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(HTML_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this HTML_DEtype object
    /// </summary>
    public virtual HTML_DEtype Clone()
    {
        return ((HTML_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
