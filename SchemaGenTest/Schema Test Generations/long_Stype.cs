...
[DataContractAttribute(Name="long_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class long_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out long_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public static long_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out long_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(long_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this long_Stype object
    /// </summary>
    public virtual long_Stype Clone()
    {
        return ((long_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
