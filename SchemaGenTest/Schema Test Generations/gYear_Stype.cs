...
[DataContractAttribute(Name="gYear_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class gYear_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out gYear_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static gYear_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((gYear_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static gYear_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out gYear_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(gYear_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this gYear_Stype object
    /// </summary>
    public virtual gYear_Stype Clone()
    {
        return ((gYear_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
