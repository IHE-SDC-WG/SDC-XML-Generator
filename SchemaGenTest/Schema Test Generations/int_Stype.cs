...
[DataContractAttribute(Name="int_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class int_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out int_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static int_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((int_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static int_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out int_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(int_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this int_Stype object
    /// </summary>
    public virtual int_Stype Clone()
    {
        return ((int_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
