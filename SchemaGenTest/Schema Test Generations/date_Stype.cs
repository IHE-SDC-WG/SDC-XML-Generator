...
[DataContractAttribute(Name="date_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class date_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out date_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static date_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((date_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static date_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out date_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(date_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this date_Stype object
    /// </summary>
    public virtual date_Stype Clone()
    {
        return ((date_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
