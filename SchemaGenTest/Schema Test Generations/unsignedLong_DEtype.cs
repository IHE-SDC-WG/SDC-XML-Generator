...
[DataContractAttribute(Name="unsignedLong_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class unsignedLong_DEtype : unsignedLong_Stype
{
    ...
    public static bool Deserialize(string input, out unsignedLong_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static unsignedLong_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((unsignedLong_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static unsignedLong_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out unsignedLong_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(unsignedLong_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this unsignedLong_DEtype object
    /// </summary>
    public virtual unsignedLong_DEtype Clone()
    {
        return ((unsignedLong_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
