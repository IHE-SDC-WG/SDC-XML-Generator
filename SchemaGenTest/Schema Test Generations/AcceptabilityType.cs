...
[DataContractAttribute(Name="AcceptabilityType", Namespace="http://healthIT.gov/sdc")]
public partial class AcceptabilityType : string_Stype
{
    ...
    public static bool Deserialize(string input, out AcceptabilityType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static AcceptabilityType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((AcceptabilityType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static AcceptabilityType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out AcceptabilityType obj, out Exception exception)
    {
        exception = null;
        obj = default(AcceptabilityType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this AcceptabilityType object
    /// </summary>
    public virtual AcceptabilityType Clone()
    {
        return ((AcceptabilityType)(MemberwiseClone()));
    }
    #endregion
}
}
