...
[DataContractAttribute(Name="RichTextType", Namespace="http://healthIT.gov/sdc")]
public partial class RichTextType : ExtensionBaseType
{
    ...
    public static bool Deserialize(string input, out RichTextType obj, out Exception exception)
    {
        exception = null;
    ...
    public static RichTextType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out RichTextType obj, out Exception exception)
    {
        exception = null;
        obj = default(RichTextType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this RichTextType object
    /// </summary>
    public virtual RichTextType Clone()
    {
        return ((RichTextType)(MemberwiseClone()));
    }
    #endregion
}
}
