...
[DataContractAttribute(Name="CommentType", Namespace="http://healthIT.gov/sdc")]
public partial class CommentType : BaseType
{
    ...
    public static bool Deserialize(string input, out CommentType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static CommentType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((CommentType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static CommentType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out CommentType obj, out Exception exception)
    {
        exception = null;
        obj = default(CommentType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this CommentType object
    /// </summary>
    public virtual CommentType Clone()
    {
        return ((CommentType)(MemberwiseClone()));
    }
    #endregion
}
}
