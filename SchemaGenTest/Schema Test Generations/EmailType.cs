...
[DataContractAttribute(Name="EmailType", Namespace="http://healthIT.gov/sdc")]
public partial class EmailType : ExtensionBaseType
{
    ...
    public static bool Deserialize(string input, out EmailType obj, out Exception exception)
    {
        exception = null;
    ...
    public static EmailType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out EmailType obj, out Exception exception)
    {
        exception = null;
        obj = default(EmailType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this EmailType object
    /// </summary>
    public virtual EmailType Clone()
    {
        return ((EmailType)(MemberwiseClone()));
    }
    #endregion
}
}
