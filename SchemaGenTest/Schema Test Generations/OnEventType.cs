...
[DataContractAttribute(Name="OnEventType", Namespace="http://healthIT.gov/sdc")]
public partial class OnEventType : IfThenType
{
    ...
    public static bool Deserialize(string input, out OnEventType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static OnEventType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((OnEventType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static OnEventType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out OnEventType obj, out Exception exception)
    {
        exception = null;
        obj = default(OnEventType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this OnEventType object
    /// </summary>
    public virtual OnEventType Clone()
    {
        return ((OnEventType)(MemberwiseClone()));
    }
    #endregion
}
}
