...
[DataContractAttribute(Name="HashType", Namespace="http://healthIT.gov/sdc")]
public partial class HashType : base64Binary_Stype
{
    ...
    public static bool Deserialize(string input, out HashType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static HashType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((HashType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static HashType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out HashType obj, out Exception exception)
    {
        exception = null;
        obj = default(HashType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this HashType object
    /// </summary>
    public virtual HashType Clone()
    {
        return ((HashType)(MemberwiseClone()));
    }
    #endregion
}
}
