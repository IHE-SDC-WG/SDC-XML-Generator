...
[DataContractAttribute(Name="ChangedFieldType", Namespace="http://healthIT.gov/sdc")]
public partial class ChangedFieldType : ExtensionBaseType
{
    ...
    [XmlElementAttribute("TargetItemID", typeof(TargetItemIDType), Order=0)]
    [XmlElementAttribute("TargetItemName", typeof(TargetItemNameType), Order=0)]
    [XmlElementAttribute("TargetItemXPath", typeof(TargetItemXPathType), Order=0)]
    [DataMemberAttribute(Name="TargetItemID", Order=0)]
    ...
    public static bool Deserialize(string input, out ChangedFieldType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static ChangedFieldType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ChangedFieldType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static ChangedFieldType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out ChangedFieldType obj, out Exception exception)
    {
        exception = null;
        obj = default(ChangedFieldType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this ChangedFieldType object
    /// </summary>
    public virtual ChangedFieldType Clone()
    {
        return ((ChangedFieldType)(MemberwiseClone()));
    }
    #endregion
}
}
