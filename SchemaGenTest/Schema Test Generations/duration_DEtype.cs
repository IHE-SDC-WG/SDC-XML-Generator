...
[DataContractAttribute(Name="duration_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class duration_DEtype : duration_Stype
{
    ...
    public static bool Deserialize(string input, out duration_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static duration_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((duration_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static duration_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out duration_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(duration_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this duration_DEtype object
    /// </summary>
    public virtual duration_DEtype Clone()
    {
        return ((duration_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
