...
[DataContractAttribute(Name="SectionItemType", Namespace="http://healthIT.gov/sdc")]
public partial class SectionItemType : SectionBaseType
{
    ...
    [XmlElementAttribute("ChildItems", Order=0)]
    [DataMemberAttribute(Name="ChildItems", Order=0)]
    ...
    public static bool Deserialize(string input, out SectionItemType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static SectionItemType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((SectionItemType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static SectionItemType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out SectionItemType obj, out Exception exception)
    {
        exception = null;
        obj = default(SectionItemType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this SectionItemType object
    /// </summary>
    public virtual SectionItemType Clone()
    {
        return ((SectionItemType)(MemberwiseClone()));
    }
    #endregion
}
}
