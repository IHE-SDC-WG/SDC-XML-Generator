...
[DataContractAttribute(Name="hexBinary_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class hexBinary_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out hexBinary_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static hexBinary_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((hexBinary_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static hexBinary_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out hexBinary_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(hexBinary_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this hexBinary_Stype object
    /// </summary>
    public virtual hexBinary_Stype Clone()
    {
        return ((hexBinary_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
