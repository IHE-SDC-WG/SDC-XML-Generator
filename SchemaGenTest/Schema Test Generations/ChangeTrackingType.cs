...
[DataContractAttribute(Name="ChangeTrackingType", Namespace="http://healthIT.gov/sdc")]
public partial class ChangeTrackingType : BaseType
{
    
    [EditorBrowsable(EditorBrowsableState.Never)]
    private BindingList<string_Stype> _changeTrackingID;
    
    private static XmlSerializer serializer;
    
    private ObjectChangeTracker changeTrackerField;
    
    [XmlElementAttribute("ChangeTrackingID", Order=0)]
    [DataMemberAttribute(Order=0)]
    public virtual BindingList<string_Stype> ChangeTrackingID
    {
        get
        {
    ...
    public static bool Deserialize(string input, out ChangeTrackingType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static ChangeTrackingType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ChangeTrackingType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static ChangeTrackingType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out ChangeTrackingType obj, out Exception exception)
    {
        exception = null;
        obj = default(ChangeTrackingType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this ChangeTrackingType object
    /// </summary>
    public virtual ChangeTrackingType Clone()
    {
        return ((ChangeTrackingType)(MemberwiseClone()));
    }
    #endregion
}
}
