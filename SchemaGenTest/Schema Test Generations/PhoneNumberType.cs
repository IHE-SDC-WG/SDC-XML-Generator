...
[DataContractAttribute(Name="PhoneNumberType", Namespace="http://healthIT.gov/sdc")]
public partial class PhoneNumberType : BaseType
{
    ...
    public static bool Deserialize(string input, out PhoneNumberType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static PhoneNumberType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((PhoneNumberType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static PhoneNumberType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out PhoneNumberType obj, out Exception exception)
    {
        exception = null;
        obj = default(PhoneNumberType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this PhoneNumberType object
    /// </summary>
    public virtual PhoneNumberType Clone()
    {
        return ((PhoneNumberType)(MemberwiseClone()));
    }
    #endregion
}
}
