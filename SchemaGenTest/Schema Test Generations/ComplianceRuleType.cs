...
[DataContractAttribute(Name="ComplianceRuleType", Namespace="http://healthIT.gov/sdc")]
public partial class ComplianceRuleType : ExtensionBaseType
{
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    private BindingList<OrganizationType> _complianceOrganization;
    ...
    [XmlElementAttribute("ComplianceOrganization", Order=1)]
    [DataMemberAttribute(Order=1)]
    public virtual BindingList<OrganizationType> ComplianceOrganization
    {
        get
        {
    ...
    public static bool Deserialize(string input, out ComplianceRuleType obj, out Exception exception)
    {
        exception = null;
    ...
    public new static ComplianceRuleType Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ComplianceRuleType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static ComplianceRuleType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out ComplianceRuleType obj, out Exception exception)
    {
        exception = null;
        obj = default(ComplianceRuleType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this ComplianceRuleType object
    /// </summary>
    public virtual ComplianceRuleType Clone()
    {
        return ((ComplianceRuleType)(MemberwiseClone()));
    }
    #endregion
}
}
