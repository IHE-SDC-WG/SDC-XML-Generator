...
[DataContractAttribute(Name="double_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class double_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out double_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static double_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((double_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static double_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out double_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(double_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this double_Stype object
    /// </summary>
    public virtual double_Stype Clone()
    {
        return ((double_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
