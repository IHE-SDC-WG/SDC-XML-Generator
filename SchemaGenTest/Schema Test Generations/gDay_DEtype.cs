...
[DataContractAttribute(Name="gDay_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class gDay_DEtype : gDay_Stype
{
    ...
    [XmlAttributeAttribute(DataType="gDay")]
    [DataMember]
    ...
    public static bool Deserialize(string input, out gDay_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static gDay_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((gDay_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static gDay_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out gDay_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(gDay_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this gDay_DEtype object
    /// </summary>
    public virtual gDay_DEtype Clone()
    {
        return ((gDay_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
