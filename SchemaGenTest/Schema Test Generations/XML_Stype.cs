...
[DataContractAttribute(Name="XML_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class XML_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out XML_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static XML_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((XML_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static XML_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out XML_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(XML_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this XML_Stype object
    /// </summary>
    public virtual XML_Stype Clone()
    {
        return ((XML_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
