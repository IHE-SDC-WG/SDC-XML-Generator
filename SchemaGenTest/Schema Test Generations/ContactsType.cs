...
[DataContractAttribute(Name="ContactsType", Namespace="http://healthIT.gov/sdc")]
public partial class ContactsType : ExtensionBaseType
{
    ...
    [XmlElementAttribute("Contact", Order=0)]
    ...
    public static bool Deserialize(string input, out ContactsType obj, out Exception exception)
    {
        exception = null;
    ...
    public static ContactsType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out ContactsType obj, out Exception exception)
    {
        exception = null;
        obj = default(ContactsType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this ContactsType object
    /// </summary>
    public virtual ContactsType Clone()
    {
        return ((ContactsType)(MemberwiseClone()));
    }
    #endregion
}
}
