...
[DataContractAttribute(Name="gMonth_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class gMonth_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out gMonth_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static gMonth_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((gMonth_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static gMonth_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out gMonth_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(gMonth_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this gMonth_Stype object
    /// </summary>
    public virtual gMonth_Stype Clone()
    {
        return ((gMonth_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
