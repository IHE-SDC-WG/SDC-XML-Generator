...
[DataContractAttribute(Name="TargetItemXPathType", Namespace="http://healthIT.gov/sdc")]
public partial class TargetItemXPathType : string_Stype
{
    ...
    public static bool Deserialize(string input, out TargetItemXPathType obj, out Exception exception)
    {
        exception = null;
    ...
    public static TargetItemXPathType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out TargetItemXPathType obj, out Exception exception)
    {
        exception = null;
        obj = default(TargetItemXPathType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this TargetItemXPathType object
    /// </summary>
    public virtual TargetItemXPathType Clone()
    {
        return ((TargetItemXPathType)(MemberwiseClone()));
    }
    #endregion
}
}
