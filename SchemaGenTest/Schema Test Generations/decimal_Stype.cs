...
[DataContractAttribute(Name="decimal_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class decimal_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out decimal_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static decimal_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((decimal_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static decimal_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out decimal_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(decimal_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this decimal_Stype object
    /// </summary>
    public virtual decimal_Stype Clone()
    {
        return ((decimal_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
