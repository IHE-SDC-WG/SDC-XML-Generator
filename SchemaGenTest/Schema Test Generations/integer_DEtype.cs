...
[DataContractAttribute(Name="integer_DEtype", Namespace="http://healthIT.gov/sdc")]
public partial class integer_DEtype : integer_Stype
{
    ...
    public static bool Deserialize(string input, out integer_DEtype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static integer_DEtype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((integer_DEtype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static integer_DEtype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out integer_DEtype obj, out Exception exception)
    {
        exception = null;
        obj = default(integer_DEtype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this integer_DEtype object
    /// </summary>
    public virtual integer_DEtype Clone()
    {
        return ((integer_DEtype)(MemberwiseClone()));
    }
    #endregion
}
}
