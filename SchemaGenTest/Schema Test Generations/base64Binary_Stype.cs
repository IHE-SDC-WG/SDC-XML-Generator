...
[DataContractAttribute(Name="base64Binary_Stype", Namespace="http://healthIT.gov/sdc")]
public partial class base64Binary_Stype : BaseType
{
    ...
    public static bool Deserialize(string input, out base64Binary_Stype obj, out Exception exception)
    {
        exception = null;
    ...
    public new static base64Binary_Stype Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((base64Binary_Stype)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    public static base64Binary_Stype Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out base64Binary_Stype obj, out Exception exception)
    {
        exception = null;
        obj = default(base64Binary_Stype);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this base64Binary_Stype object
    /// </summary>
    public virtual base64Binary_Stype Clone()
    {
        return ((base64Binary_Stype)(MemberwiseClone()));
    }
    #endregion
}
}
