...
[DataContractAttribute(Name="UnitsType", Namespace="http://healthIT.gov/sdc")]
public partial class UnitsType : string_Stype
{
    ...
    public static bool Deserialize(string input, out UnitsType obj, out Exception exception)
    {
        exception = null;
    ...
    public static UnitsType Deserialize(Stream s)
    {
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool LoadFromFile(string fileName, out UnitsType obj, out Exception exception)
    {
        exception = null;
        obj = default(UnitsType);
        try
    ...
    #region Clone method
    /// <summary>
    /// Create a clone of this UnitsType object
    /// </summary>
    public virtual UnitsType Clone()
    {
        return ((UnitsType)(MemberwiseClone()));
    }
    #endregion
}
}
